                        ...
                        <form>
                            <div className="row1">
                                ...
                                <?php endforeach; ?> */}
                                    ...
                                    <input type="text" name="trongluong" className="inputSp" value="" /><br />
                                    <label style={{fontSize: "20px",marginTop: "7px"}}>Màn hình</label><br />
                                    <input type="text" className="inputSp" name="manhinh" value="" /><br />
                                    <label style={{fontSize: "20px",marginTop: "7px"}}>Ổ cứng</label><br />
                                    <input type="text" className="inputSp" name="ocung" value="" /><br />
                                    <label style={{fontSize: "20px",marginTop: "7px"}}>CPU</label><br />
                                    <input type="text" className="inputSp" name="cpu" value="" /><br />
                                    <label style={{fontSize: "20px",marginTop: "15px"}}>RAM</label><br />
                                    <input type="text" className="inputSp" name="ram" value="" /><br />
                                </div>
                                <div className="col-sm-9 right-row" style={{float:"left"}}>
                                    ...
                                    <input type="text" style={{marginTop: "10px", fontSize: "20px", width: "200px", float:"right"}} name="masp" value="" readonly /><br />
                                    ...
                                    <input type="text" style={{marginTop: "10px", fontSize: "20px", width: "345px"}} name="tensp" value="" /><br />
                                    ...
                                    <div className="subsub0" style={{marginBottom:"-10px"}}>
                                        <div className="subsub1">
                                            ...
                                            <input type="text" style={{marginTop: "10px", fontSize: "20px", width: "125px"}} name="soluong" value="" />
                                        </div>
                                        <div className="subsub2">
                                            <label style={{fontSize: "20px",marginTop: "7px"}}>Giá</label><br />
                                            <input type="text" style={{marginTop: "10px", fontSize: "20px", width: "200px"}} name="gia" value="" />
                                        </div>
                                    </div>
                                    <label style={{marginTop: "25px", fontSize: "20px"}}>Màu</label><br />
                                    <input type="text" className="inputSp" name="mausac" value="" /><br />
                                ...
                                >Mỏng nhẹ cao cấp</option> */}
                                    ...
                                    <input type="text" className="inputSp" name="vga" value="" /><br />
                                    <label style={{fontSize: "20px",marginTop: "15px"}}>PIN</label><br />
                                    <input type="text" className="inputSp" name="pin" value="" /><br />
